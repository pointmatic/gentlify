...
- `ruff format` applied to `_config.py`, `_throttle.py`, `test_retry.py` to fix CI formatting check failures

## [1.6.0] - 2026-02-08

### Added

- Updated `README.md` with retry section and usage examples
- Updated `CHANGELOG.md` with v1.1.0–v1.5.0 entries
